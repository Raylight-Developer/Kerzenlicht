...
KL::NODE::PORT::Data_I_Port::Data_I_Port(Node* node, const uint16& slot_id, const PROP::Type& type, const CORE::PROP::Modifier& modifier) :
	Port(node),
	data_type(type),
	modifier(modifier)
{
...
KL::NODE::PORT::Data_O_Port::Data_O_Port(Node* node, const uint16& slot_id, const PROP::Type& type, const CORE::PROP::Modifier& modifier) :
	Port(node),
	data_type(type),
	modifier(modifier)
{
