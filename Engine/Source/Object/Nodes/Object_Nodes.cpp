...
void EXEC::Script::addDataInput(const uint16& slot_id, const string& map_name, const PROP::Type& type, const CORE::PROP::Modifier& modifier) {
	PORT::Data_I_Port* value = new PORT::Data_I_Port(this, slot_id, type, modifier);
	data_inputs[map_name] = value;
	inputs.push_back(value);
};

void EXEC::Script::addDataOutput(const uint16& slot_id, const string& map_name, const PROP::Type& type, const CORE::PROP::Modifier& modifier) {
...
void KL::NODE::EXEC::Script_Node::addDataInput (const string& map_name, const PROP::Type& type, const CORE::PROP::Modifier& modifier) const {
	node->addDataInput (static_cast<uint16>(node->inputs .size()), map_name, type, modifier);
}
void KL::NODE::EXEC::Script_Node::addDataOutput(const string& map_name, const PROP::Type& type, const CORE::PROP::Modifier& modifier) const {
