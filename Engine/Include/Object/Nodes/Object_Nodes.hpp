	...
	namespace NODE {
		...
		namespace EXEC {
			...
			struct Script : Node {
				...
				void addDataInput (const uint16& slot_id, const string& map_name, const PROP::Type& type, const CORE::PROP::Modifier& modifier = CORE::PROP::Modifier::SINGLE);
				void addDataOutput(const uint16& slot_id, const string& map_name, const PROP::Type& type, const CORE::PROP::Modifier& modifier = CORE::PROP::Modifier::SINGLE);
			...
			public:
				...
				// Create a new port
				virtual void addDataInput (const string& map_name, const PROP::Type& type, const CORE::PROP::Modifier& modifier = CORE::PROP::Modifier::SINGLE) const;
				// Create a new port
				virtual void addDataOutput(const string& map_name, const PROP::Type& type, const CORE::PROP::Modifier& modifier = CORE::PROP::Modifier::SINGLE) const;
				// Create a new port
