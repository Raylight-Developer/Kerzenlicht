	...
	namespace NODE {
		...
		namespace PORT {
			...
			struct Data_I_Port : Port {
				...
				Data_I_Port(Node* parent, const uint16& slot_id, const PROP::Type& type, const CORE::PROP::Modifier& modifier = CORE::PROP::Modifier::SINGLE);
				~Data_I_Port();
			...
			struct Data_O_Port : Port {
				...
				Data_O_Port(Node* parent, const uint16& slot_id, const PROP::Type& type, const CORE::PROP::Modifier& modifier = CORE::PROP::Modifier::SINGLE);
				~Data_O_Port();
